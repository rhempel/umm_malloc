...
TEST(TooBigMalloc, testHeapFirstMallocMaxHeapBlocksMinus3)
{
    ...
    CHECK_TRUE(check_blocks(&umm_test_heap_config, MallocMaxHeapBlocksMinus3_test_values, ARRAYELEMENTCOUNT(MallocMaxHeapBlocksMinus3_test_values)));
...
TEST(TooBigMalloc, testHeapTooBigMalloc_BigThenSmallMax)
{
    ...
    CHECK_TRUE(check_blocks(&umm_test_heap_config, MallocMaxHeapBlocksBig_test_values, ARRAYELEMENTCOUNT(MallocMaxHeapBlocksBig_test_values)));

    // Then allocate exactly one more block ...
    //
    POINTERS_EQUAL((void *)&test_umm_heap[UMM_LASTBLOCK-1][UMM_BLOCK_HEADER_SIZE], (umm_malloc(1)));
    CHECK_TRUE(check_blocks(&umm_test_heap_config, MallocMaxHeapBlocksBigThenSmall_test_values, ARRAYELEMENTCOUNT(MallocMaxHeapBlocksBigThenSmall_test_values)));
...
TEST(TooBigMalloc, testHeapTooBigMalloc_SmallThenBigMax)
{
    ...
    CHECK_TRUE(check_blocks(&umm_test_heap_config, MallocMaxHeapBlocksSmall_test_values, ARRAYELEMENTCOUNT(MallocMaxHeapBlocksSmall_test_values)));
    ...
    CHECK_TRUE(check_blocks(&umm_test_heap_config, MallocMaxHeapBlocksSmallThenBig_test_values, ARRAYELEMENTCOUNT(MallocMaxHeapBlocksSmallThenBig_test_values)));
...
TEST(TooBigMalloc, testHeapTooBigMalloc_SmallThenBigMax_ReverseFree)
{
    ...
    umm_free((void *)&test_umm_heap[1][UMM_BLOCK_HEADER_SIZE]);
    CHECK_TRUE(check_blocks(&umm_test_heap_config, MallocMaxHeapBlocksSmallThenBig_ReverseFreetest_values, ARRAYELEMENTCOUNT(MallocMaxHeapBlocksSmallThenBig_ReverseFreetest_values)));
